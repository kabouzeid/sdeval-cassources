...
the gk dimension of a free algebra over QQ from the output of the computer algebra
system Singular.
...
def extractSolution(outpString):
    """
    This function extracts the solution of a gkobal Dimension
    ...
    #Adding the basis
    tempNodeGlDim = tempNode.appendChild(result.createElement("gkdim"))
